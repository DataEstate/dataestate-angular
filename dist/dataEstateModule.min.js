...
return void 0!==i&&(d.language=i),void 0!==a&&null!==a&&Object.keys(a).length>0&&(d.remove=a),void 0!==o&&null!==o&&(d.add=o),e.put(r,d)},create:function(n,i,a){a.hasOwnProperty("type")||(a.type=i),void 0===n&&(n=t)
...
var o=a.join(";")
t.parent().on("mouseover",function(e){t.attr("style",o),t.appendTo(i.parent())}),t.parent().on("mouseout",function(){t.remove()}),t.remove()}}}),de.directive("jqAutocomplete",function(){return{require:"ngModel",scope:{source:"=jqAutoSource",onCreate:"&?jqOnCreate",onSelect:"&?jqOnSelect",onFocus:"&?jqOnFocus",jqShowfield:"=",minLength:"=jqMinLength"},link:function(e,t,n,i){t.autocomplete({minLength:void 0===e.minLength||isNaN(e.minLength)?2:e.minLength,source:e.source,create:function(n,i){void 0!==e.onCreate&&e.onCreate({$event:n,element:t})},focus:function(e,n){e.preventDefault(),t.val(n.item?n.item.label:"")},select:function(a,o){a.preventDefault(),i.$setViewValue(o.item.value),t.val(o.item?o.item.label:""),"value"==n.jqShowfield?t.val(o.item?o.item.value:""):t.val(o.item?o.item.label:""),void 0!==e.onSelect&&"function"==typeof e.onSelect&&e.onSelect({$event:a,$ui:o})},change:function(e,n){e.preventDefault(),null===n.item?(t.val(""),i.$setViewValue(null)):i.$setViewValue(n.item.value)}}).data("ui-autocomplete")._renderItem=function(e,t){var n=String(t.label).replace(new RegExp(this.term,"ig"),'<span class="ui-autocomplete-highlight">'+this.term+"</span>")
return $('<li class="ui-menu-item"></li>').data("item.autocomplete",t).append('<div class="ui-menu-item-wrapper">'+n+"</div>").appendTo(e)}}}}),de.directive("deCurrency",function(){return{restrict:"E",scope:{money:"=ngModel"},link:function(e,t,n){e.editing=!1,e.toggleEdit=function(t){e.editing=t}},template:'<input type="number" ng-model="money" ng-show="editing" ng-blur="toggleEdit(false)"><span ng-bind="money | currency" ng-hide="editing" ng-click="toggleEdit(true)"></span>'}}),de.factory("DeChangeRegister",function(e){function t(e,t,n){if(void 0!==e&&void 0!==t&&void 0!==n)return void 0===i[e]&&(i[e]={}),void 0===a[e]&&(a[e]={}),i[e][t]=angular.copy(n),a[e][t]=n,!0}var n={},i={},a={},o={}
return{registerTracking:function(e,n,i,a){void 0!==e&&void 0!==n&&void 0!==i&&(t(e,n,i),void 0!==a&&(void 0===o[e]&&(o[e]={}),o[e][n]=a))},commitTracking:function(e,t){if(void 0===e)i={},n={}
else{if(void 0!==a[e])if(void 0!==t&&void 0!==a[e][t])i[e][t]=angular.copy(a[e][t]),void 0!==o[e]&&void 0!==o[e][t]&&"function"==typeof o[e][t].DeChangeReset&&o[e][t].DeChangeReset()
else if(i[e]=angular.copy(a[e]),void 0!==o[e])for(var r in o[e])"function"==typeof o[e][r].DeChangeReset&&o[e][r].DeChangeReset()
void 0!==n[e]&&void 0!==t&&delete n[e][t]}},resetTracking:t,trackChanges:function(t,a,o){if(void 0!==i[t]&&void 0!==i[t][a]){var r=e.getDiff(i[t][a],o,!0)
return e.isEmpty(r.changed)&&e.isEmpty(r.removed)?(void 0!==n[t]&&delete n[t][a],!1):(void 0===n[t]&&(n[t]={}),n[t][a]=r,!0)}},getChanges:function(e,t){return void 0!==e&&void 0!==n[e]?void 0===t||void 0===n[e][t]?n[e]:n[e][t]:null},getOriginals:function(e,t){return void 0!==e&&void 0!==i[e]?void 0!==t&&void 0!==i[e][t]?i[e][t]:i[e]:i},hasChanged:function(e,t){var n=!0
