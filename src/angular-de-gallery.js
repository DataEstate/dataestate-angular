			...
			$scope.selectImage = function () {
				...
				if (trigger.hasOwnProperty("galleryModel")) {
					...
					if ($scope.selectedImg.hasOwnProperty('alt')) {
						...
						selectedImgData.caption = $scope.selectedImg.caption;
					}
					...
					if ($scope.selectedImg.hasOwnProperty('sqId')) {
						selectedImgData.sqId = $scope.selectedImg.sqId;
					}
					if ($scope.selectedImg.hasOwnProperty('atdw_sq_number')) {
						selectedImgData.atdw_sq_number = $scope.selectedImg.atdw_sq_number;
					}
					switch (assignType) {
						case "array":
